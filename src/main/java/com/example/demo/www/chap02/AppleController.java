...
public class AppleController {	
	public static void main(String... args) {
		...
		for(Apple a : as.filterApples(ls, (Apple a) -> a.getColor().equals(Color.GREEN) )) print.accept(a.toString());
		...
		Comparator<Apple> c = new Comparator<Apple>() {
			...
			public int compare(Apple o1, Apple o2) {
				return new Integer(o1.getWeight()).compareTo(Integer.valueOf(o2.getWeight()));
			}
		};
		...
		// 위 코드를 더 간략화 시키자. 단 import static java.util.Comparator.comparing; 은 직접 import 시켜야 하므로 주의
