    ...
    <table class="my-tab" id="mgr-tab">
    	...
    	<tr>
    		<td>학 생 (총 <span id="stu-count"></span> 명) <button id="mgr-truncate-stu">전체삭제</button><br/><br/>
	    		...
	    		<input type="radio" name="stu-data-gender" value="M" checked="checked"/>여성 <!--  P.167 anyMatch -->
	    		<input type="radio" name="stu-data-gender" value="F" style="margin-left:20px"/>남성<button style="margin-left:38px">성별조회</button><br/><br/>
